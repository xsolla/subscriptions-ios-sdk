...
class XSDKNetworkSession
{
    private(set) var session: URLSession!

    weak var delegate: URLSessionDataDelegate? { didSet { invalidateAndCancel() } }
    var delegateQueue: OperationQueue? { didSet { invalidateAndCancel() } }
    var configuration: URLSessionConfiguration? { didSet { invalidateAndCancel() } }
