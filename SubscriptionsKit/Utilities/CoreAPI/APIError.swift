...
enum APIError<ErrorModel: APIDecodableErrorModelProtocol>: Error
{
    /// 204 No Content
    case noContent
...
enum APIErrorTemplateMessages
{
    static let descriptionUnprocessed = "Unprocessed error"
    static let descriptionEmptyData = "Empty error data"
}
