...
class APIServerCode400ErrorHandler: APIServerCodeErrorHandler
{
    var code: Int { 400 } // 400 Bad request
    
    func error<ErrorModel>(data: Data?, decoder: JSONDecoder?) -> APIError<ErrorModel>? where ErrorModel: APIDecodableErrorModelProtocol
    {
