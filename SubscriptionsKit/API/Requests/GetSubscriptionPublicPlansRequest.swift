...
class GetSubscriptionPublicPlansRequest: SubscriptionsBaseRequest<GetSubscriptionPublicPlansRequest.Params>,
                             APIRequestProtocol
{
    typealias ResponseModel = GetSubscriptionPublicPlansResponse
    ...
    override var relativePath: String { "/public/v1/projects/\(String(params.projectId))/user_plans" }
...
extension GetSubscriptionPublicPlansRequest
{
