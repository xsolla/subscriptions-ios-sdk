...
class GetSubscriptionPurchaseUrlRequest: SubscriptionsBaseRequest<GetSubscriptionPurchaseUrlRequest.Params>,
                                  APIRequestProtocol
{
    typealias ResponseModel = GetSubscriptionPurchaseUrlResponse
    ...
    override var relativePath: String { "/user/v1/projects/\(String(params.projectId))/subscriptions/buy" }
    ...
    {
        BodyParams(planExternalId: params.planExternalId, settings: .init(sandbox: true))
    }
...
extension GetSubscriptionPurchaseUrlRequest
{
    struct Params: RequestParams
    {
        ...
        let paystationSettings: PaystationSettings?
    }

    struct BodyParams: Encodable
    {
        var planExternalId: String
        var settings: PaystationSettings?
