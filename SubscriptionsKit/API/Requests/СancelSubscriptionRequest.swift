...
class СancelSubscriptionRequest: SubscriptionsBaseRequest<СancelSubscriptionRequest.Params>,
                                 APIRequestProtocol
{
    typealias ResponseModel = SubscriptionsAPIEmptyResponse
    ...
    override var relativePath: String { "/user/v1/projects/\(String(params.projectId))/subscriptions/\(params.subscriptionId)/cancel" }
...
extension СancelSubscriptionRequest
{
