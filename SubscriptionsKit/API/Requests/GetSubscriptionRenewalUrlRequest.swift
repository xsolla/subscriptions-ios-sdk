...
class GetSubscriptionRenewalUrlRequest: SubscriptionsBaseRequest<GetSubscriptionRenewalUrlRequest.Params>,
                                    APIRequestProtocol
{
    typealias ResponseModel = GetSubscriptionRenewalUrlResponse
    ...
    override var relativePath: String { "/user/v1/projects/\(String(params.projectId))/subscriptions/\(params.subscriptionId)/renew" }
...
extension GetSubscriptionRenewalUrlRequest
{
